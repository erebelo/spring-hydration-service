package com.erebelo.springhydrationservice;
...
class SpringHydrationServiceApplicationTest {
    ...
    void mainRunSuccessful() {
        try (MockedStatic<SpringApplication> mockedStatic = mockStatic(SpringApplication.class)) {
            ...
            SpringHydrationServiceApplication.main(new String[]{});

            mockedStatic.verify(() -> SpringApplication.run(SpringHydrationServiceApplication.class, new String[]{}));
        }
    }
}
